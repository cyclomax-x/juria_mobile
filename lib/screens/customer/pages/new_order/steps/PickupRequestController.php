    ...
    public function create()
    {
        try {
            ...
            if ($passport_photo && $passport_photo->isValid() && !$passport_photo->hasMoved()) {
                ...
                $passport_photo->move('assets/images/passports', $senderFileName);
            } else {
            ...
            if ($recipient_passport_photo && $recipient_passport_photo->isValid() && !$recipient_passport_photo->hasMoved()) {
                ...
                $recipient_passport_photo->move('assets/images/passports', $recipientFileName);
            } else {
            ...
            if ($action == 'save') {
                ...
                if ($saveData == 0) {
                    ...
                    return $this->response->setJSON(['action' => 'save', 'status' => 200, 'message' => 'Parcel Added successfully! Order ID: ' . $saveData['id'], 'id' => $saveData['id'], 'reference' => $saveData['reference']]);
                }
            } else {
                ...
                if (!$existingCustomer) {
                    ...
                    $customerReg = $customerModel->insert($data);
                ...
                if ($finalizeData == 0) {
                    ...
                    return $this->response->setJSON(['action' => 'finalize', 'status' => 200, 'message' => 'Parcel Added successfully! Order ID: ' . $finalizeData['id'], 'id' => $finalizeData['id'], 'reference' => $finalizeData['reference']]);
                }
            }
        } catch (\Exception $e) {
